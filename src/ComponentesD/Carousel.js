...
function Carousel({ primaryColor, secondaryColor, backgroundColor }) {
  const settings = {
    dots: true,
    infinite: true,
  ...
  return (
    <Slider {...settings} className="carousel-container">
      <div className="carousel-slide" style={{ backgroundColor: backgroundColor }}>
        <img 
          src="https://hips.hearstapps.com/hmg-prod/images/sin-novedad-en-el-frente-pelicula-netflix-66addae05da60.jpg?crop=1xw:1xh;center,top&resize=1200:*" 
          alt="Imagen 1" 
      ...
      <div className="carousel-slide" style={{ backgroundColor: backgroundColor }}>
        <img 
          src="https://www.spgtalleres.com/_images/news/248/7562_modal.jpg" 
          alt="Imagen 2" 
          className="carousel-image" 
        />
        <div 
      ...
      <div className="carousel-slide" style={{ backgroundColor: backgroundColor }}>
        <img 
          src="https://i.blogs.es/e393df/diseno-sin-titulo/500_333.jpeg" 
          alt="Imagen 3" 
          className="carousel-image" 
        />
        <div 
